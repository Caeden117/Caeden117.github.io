...
subtitle: "Why you should care about CosmiChord and my capstone."
...
- **Targets**, which are your traditional "note". Slice in the corresponding direction as they approach.
- **Ribbons**, which are long bands that you trace with your controllers.
- **Walls**, which you must dodge with your head.
- **Tunnels**, which are circular rings that you must keep your head within.
- **Blocks**, which are purely decorative objects for level scenery.

CosmiChord comes with an Original Soundtrack (OST) of about a dozen licensed songs from artists such as [Creo](https://www.youtube.com/channel/UCsCWA3Y3JppL6feQiMRgm6Q) and [BoomKitty](https://www.youtube.com/@BoomKitty). The OST is mapped by a fantastic level design team to have multiple difficulties, ranging from Easy difficulty designed for VR newcomers to Master difficulty for VR rhythm game veterans.
